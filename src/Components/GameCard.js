...
// 			console.log('Detected sign:', result.name); // Log the detected sign
			
// 			if (result.name && result.name.toUpperCase() === letter.toUpperCase()) {
// 				setSuccess(true);
// 				setTimeout(() => {
// 					next();
// 				}, 1000);
...
// 					<FaBackwardFast />
// 				</Button>
// 				<Button onClick={next} style={{ backgroundColor: "#121212" }}>
// 					<FaForwardFast />
// 				</Button>
// 			</Row>
